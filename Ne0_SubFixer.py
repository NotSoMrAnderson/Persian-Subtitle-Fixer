...
class MainWindow(QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowIcon(QtGui.QIcon(r"C:\Users\HellBlazer\PycharmProjects\SubFixer\assets\comics-mask_97446.ico"))
...
class MyBar(QWidget):
    ...
    def __init__(self, parent):
        super().__init__()
        self.parent = parent
        self.layoout = QHBoxLayout()
        self.layoout.setContentsMargins(0, 0, 5, 5)
        ...
        self.layoout.addWidget(self.title)
        self.layoout.addWidget(self.btn_help)
        self.layoout.addWidget(self.btn_min)
        self.layoout.addWidget(self.btn_close)
